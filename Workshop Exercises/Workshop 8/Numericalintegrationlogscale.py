...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 15:51:09 2020
...
def rectint(a, b, N, func):
    ...
    integral = integral * h
    if func == func1:
        integralerror = np.log(abs(0.550935173739280 - integral))
    else:
        integralerror = np.log(abs((1/(4+16*(np.pi)**2))*(1-np.exp(-4)) - integral))
...
plt.xlabel('N')
plt.ylabel('log Error in integral approx')
plt.legend()
